...
@section('header')
    <div class="page-header clearfix">
        <h1>
            ...
            <a class="btn btn-success pull-right" href="{{ route('cube_sumation_commands.create') }}"><i class="glyphicon glyphicon-plus"></i> Create</a>
        </h1>
        ...
        <div class="col-md-12">
            @if($cube_sumation_commands->count())
                <table class="table table-condensed table-striped">
                    ...
                    <td>{{$cube_sumation_command->params}}</td>
                                <td class="text-right">
